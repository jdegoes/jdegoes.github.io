---
layout:       post
title:        "Everyone Is Religious—Even You"
description:  "A diagnostic framework for identifying the religion everyone has—including the ones that deny being religions"
category:     articles
tags:         [religion, Christianity, framework, wokeism, therapeutic individualism, secularism]
---
...
Every religion has a _god_—not necessarily a supernatural being, but that which holds ultimate authority and commands final loyalty.
...
Every religion has an _Enemy_—that which fundamentally opposes the god and must be fought.
...
_Human Nature_ specifies what humans are born as—and what they can become.
...
_Heaven_ specifies the future state that makes serving the god rational—where the struggle leads, what victory looks like, and what future justifies present cost.
...
_Epistemology_ specifies how truth is grounded—what counts as knowledge and what stable reference, if any, anchors it.
...
_Authority_ specifies the structure of institutional power—who holds interpretive authority and how that authority legitimately transfers.
...
_Ethics_ specifies what the religion demands—the conduct required, the means forbidden, and the cost to human nature.
...
_Membership_ specifies how the religion constitutes and perpetuates its community—who belongs, how membership is maintained, and how new members are made.
...
_Narrative_ is the coherent, transmissible self-presentation of the religion as a story, including its exemplars.
...
_Liturgy_ consists of the embodied practices that shape believers and structure sacred time.
...
_Camouflage_ measures the degree to which a religion conceals its nature as religion—from outsiders, from host institutions, and from its own believers.

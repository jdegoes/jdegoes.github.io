...
As of the date of this writing, we are just weeks away from the moment when the new runtime system first successfully passed the battery of automated tests that helps verifh runtime system integrity.
...
You won’t be disappointed. And if you *are* disappointed, we’ll turn your feedback into ZIO 3!
